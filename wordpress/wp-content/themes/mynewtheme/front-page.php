...
<div class="header-carousel owl-carousel">
    <div class="header-carousel-item">
        <div class="header-carousel-item-img-1">
            <img src="<?php echo get_theme_file_uri() ?>/assets/img/carousel-1.jpg" class="img-fluid w-100" alt="Image">
        </div>
    ...
    <div class="header-carousel-item mx-auto">
        <div class="header-carousel-item-img-2">
            <img src="<?php echo get_theme_file_uri() ?>/assets/img/carousel-2.jpg" class="img-fluid w-100" alt="Image">
        </div>
        <div class="carousel-caption">
    ...
    <div class="header-carousel-item">
        <div class="header-carousel-item-img-3">
            <img src="<?php echo get_theme_file_uri() ?>/assets/img/carousel-3.jpg" class="img-fluid w-100" alt="Image">
        </div>
        <div class="carousel-caption">
    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 col-xl-5 wow fadeInLeft" data-wow-delay="0.1s">
                <div class="about-img">
                    <img src="<?php echo get_theme_file_uri() ?>/assets/img/about-3.png" class="img-fluid w-100 rounded-top bg-white" alt="Image">
                    <img src="<?php echo get_theme_file_uri() ?>/assets/img/about-2.jpg" class="img-fluid w-100 rounded-bottom" alt="Image">
                </div>
            </div>
                ...
                <div class="row g-4 justify-content-between mb-5">
                    ...
                    <div class="col-xl-7 mb-5">
                        <div class="about-customer d-flex position-relative">
                            <img src="<?php echo get_theme_file_uri() ?>/assets/img/customer-img-1.jpg" class="img-fluid btn-xl-square position-absolute" style="left: 0; top: 0;" alt="Image">
                            <img src="<?php echo get_theme_file_uri() ?>/assets/img/customer-img-2.jpg" class="img-fluid btn-xl-square position-absolute" style="left: 45px; top: 0;" alt="Image">
                            <img src="<?php echo get_theme_file_uri() ?>/assets/img/customer-img-3.jpg" class="img-fluid btn-xl-square position-absolute" style="left: 90px; top: 0;" alt="Image">
                            <img src="<?php echo get_theme_file_uri() ?>/assets/img/customer-img-1.jpg" class="img-fluid btn-xl-square position-absolute" style="left: 135px; top: 0;" alt="Image">
    ...
    <div class="container py-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
         ...
         <div class="row g-4 justify-content-center text-center">
            ...
            <div class="col-12">
                <a class="btn btn-primary rounded-pill py-3 px-5 wow fadeInUp" data-wow-delay="0.1s" href="<?php echo site_url( '/services' ) ?>">Services More</a>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="project-item h-100 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="project-content bg-light rounded p-4">
                        <div class="project-content-inner">
                            ...
                            <p class="text-dark fs-5 mb-3"><?php the_category( ); ?></p>
...
<div class="container-fluid blog pb-5">
    <div class="container pb-5">
        ...
        <!-- <div class="row g-4 justify-content-center">
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="blog-item bg-light rounded p-4" style="background-image: url(<?php echo get_theme_file_uri() ?>/assets/img/bg.png);">
                            <div class="mb-4">
                            ...
                            <div class="project-img">
                                <img src="<?php echo get_theme_file_uri() ?>/assets/img/blog-1.jpg" class="img-fluid w-100 rounded" alt="Image">
                                <div class="blog-plus-icon">
                                    <a href="<?php echo get_theme_file_uri() ?>/assets/img/blog-1.jpg" data-lightbox="blog-1" class="btn btn-primary btn-md-square rounded-pill"><i class="fas fa-plus fa-1x"></i></a>
                                </div>
                            </div>
                            <div class="my-4">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="blog-item bg-light rounded p-4" style="background-image: url(<?php echo get_theme_file_uri() ?>/assets/img/bg.png);">
                            ...
                            <div class="project-img">
                                <img src="<?php echo get_theme_file_uri() ?>/assets/img/blog-2.jpg" class="img-fluid w-100 rounded" alt="Image">
                                <div class="blog-plus-icon">
                                    <a href="<?php echo get_theme_file_uri() ?>/assets/img/blog-2.jpg" data-lightbox="blog-2" class="btn btn-primary btn-md-square rounded-pill"><i class="fas fa-plus fa-1x"></i></a>
                                </div>
                            </div>
                            <div class="my-4">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="blog-item bg-light rounded p-4" style="background-image: url(<?php echo get_theme_file_uri() ?>/assets/img/bg.png);">
                            ...
                            <div class="project-img">
                                <img src="<?php echo get_theme_file_uri() ?>/assets/img/blog-3.jpg" class="img-fluid w-100 rounded" alt="Image">
                                <div class="blog-plus-icon">
                                    <a href="<?php echo get_theme_file_uri() ?>/assets/img/blog-3.jpg" data-lightbox="blog-3" class="btn btn-primary btn-md-square rounded-pill"><i class="fas fa-plus fa-1x"></i></a>
                                </div>
                            </div>
                            <div class="my-4">
...
<!-- sidear -->
<?php echo do_shortcode('[hr_notices_floating]'); ?>
<!-- end sidebar -->
...
<div class="container-fluid team pb-5">
    <div class="container pb-5">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <?php echo do_shortcode('[hr_employees]'); ?>
