...
namespace FakerPress\ThirdParty\Cake\Chronos;
...
class ChronosDate implements Stringable
{
     ...
     *
     * @var \FakerPress\ThirdParty\Cake\Chronos\DifferenceFormatterInterface|null
     */
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosDate|\DateTimeInterface|string $time Fixed or relative time
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosDate|\DateTimeInterface|string $time The strtotime compatible string to parse
     * @return static
     */
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\DifferenceFormatterInterface|null $formatter The formatter instance when setting.
     * @return \FakerPress\ThirdParty\Cake\Chronos\DifferenceFormatterInterface The formatter instance.
     */
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosDate $target Target instance
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosDate $other The instance to compare with.
     * @return bool
     */
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosDate $start Start of target range
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosDate $end End of target range
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosDate $first The instance to compare with.
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosDate $second The instance to compare with.
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosDate ...$others Others instance to compare with.
     * @return self
     */
     ...
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosDate|null $other The instance to difference from.
     ...
     * 5 months after
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosDate|null $other The datetime to compare with.
