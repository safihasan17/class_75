...
class ChronosTime implements Stringable
{
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosTime|\DateTimeInterface|string|null $time Time
     ...
     * Defaults to server time.
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosTime|\DateTimeInterface|string $time Time
     * @param \DateTimeZone|string|null $timezone The timezone to use for now
     * @return static
     */
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosTime $target Target time
     * @return bool
     */
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosTime $start Start of target range
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosTime $end End of target range
