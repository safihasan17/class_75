...
class Chronos extends DateTimeImmutable implements Stringable
{
     ...
     *
     * @var \FakerPress\ThirdParty\Cake\Chronos\Chronos|null
     */
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosDate|\FakerPress\ThirdParty\Cake\Chronos\ChronosTime|\DateTimeInterface|string|int|null $time Fixed or relative time
     ...
     * parameter of null.
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\Chronos|string|null $testNow The instance to use for all future instances.
     * @return void
     */
     ...
     * instance is created.
     *
     * @return \FakerPress\ThirdParty\Cake\Chronos\Chronos|null The current instance used for testing
     */
     ...
     *
     * @param \FakerPress\ThirdParty\Cake\Chronos\ChronosDate|\FakerPress\ThirdParty\Cake\Chronos\ChronosTime|\DateTimeInterface|string|int|null $time The strtotime compatible string to parse
