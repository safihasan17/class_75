drop database if exists newexams;
create database newexams;
use newexams;
...
insert into product(name, price, manufacturer_id ) values("laptop", "1400", 1);
insert into product(name, price, manufacturer_id ) values("mouse", "800", 2);
insert into product(name, price, manufacturer_id ) values("Montor", "1200", 3);
