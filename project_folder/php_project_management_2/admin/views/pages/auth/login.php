                ...
                <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-lg" name="email" placeholder="" value="safihsan@gmail.com">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-label-group">
                        ...
                        <div class="form-control-wrap">
                            <a href="#" class="form-icon form-icon-right passcode-switch lg" data-target="password" value="123">
